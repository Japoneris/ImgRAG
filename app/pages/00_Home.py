...
- **Ingest Images**: Scan directories or use YAML configs for batch processing
- **Index Management**: Navigation hub for database management tools
  - Rebuild Index: Recreate hash→filepath mapping
